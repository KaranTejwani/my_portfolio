...
const experiences = [
    ...
    {
        id: 4, title: 'Sindh Educational Organization', role: 'Board of Directors',
        duration: 'Feb 2024 - Present', location: 'Sindh',
        description: 'Guiding strategic decisions and educational outreach initiatives.',
        highlights: ['Strategy', 'PR', 'Outreach'], current: true,
    },
];
        ...
        <section id="experience" className="relative py-28 md:py-36">
            <div className="section-container">
                ...
                <SectionReveal className="mb-14">
                    ...
                    <p className="text-text-secondary">Professional journey and key milestones</p>
                </SectionReveal>
                                ...
                                <div className="relative pl-14 md:pl-18">
                                    ...
                                    <div className="obsidian-card p-6">
                                        ...
                                        <div className="flex flex-wrap items-center gap-3 mb-2">
                                            ...
                                            {exp.current && (
                                                <span className="px-2 py-0.5 rounded-full bg-accent/10 border border-accent/20 text-accent text-xs font-semibold">
                                                    Current
                                                </span>
                                            )}
                                        </div>
